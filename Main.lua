    ...
    Themes = {
        Cyberpunk = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 180, 200)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 0)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(160, 50, 200))
            }),
            ["Color Hub 2"] = Color3.fromRGB(0, 0, 0),
            ["Color Stroke"] = Color3.fromRGB(0, 180, 200),
            ["Color Theme"] = Color3.fromRGB(0, 200, 220),
            ["Color Text"] = Color3.fromRGB(200, 220, 255),
            ["Color Dark Text"] = Color3.fromRGB(100, 150, 200),
            ["Color Element"] = Color3.fromRGB(0, 0, 0),
            ["Color Element Stroke"] = Color3.fromRGB(0, 100, 150)
        }
    }, 
    Info = {
        Version = "1.2.0"
...
local SetProps, SetChildren, InsertTheme, Create do
    ...
    pcall(Save, "Ghost library V1.json")
end
...
AddEle("Button", function(parent, props, ...)
    ...
    Make("Stroke", New, {
        Color = Theme["Color Element Stroke"]
    })
    Make("Corner", New)
    
    New.MouseEnter:Connect(function()
        New.BackgroundTransparency = 0.1
    end)
    New.MouseLeave:Connect(function()
        New.BackgroundTransparency = 0.25
    end)
    if args[1] then
...
function redzlib:SetTheme(NewTheme)
    ...
    SaveJson("Ghost library V1.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
    local WTitle = Configs[1] or Configs.Name or Configs.Title or "Ghost Library V5"
    local WMiniText = Configs[2] or Configs.SubTitle or "by : Ghost"
    ...
    Make("Corner", WindowBackground, UDim.new(0, 16))
    ...
    local function ControlSize()
        ...
        ControlSize2.Position = UDim2.new(0, math.clamp(Pos2.X.Offset, 120, 200), 1, 0)
    ...
    ConnectSave(ControlSize1, function()
        if not Minimized then
            ...
            SaveJson("Ghost library V5.json", redzlib.Save)
        end
    end)
    ...
    function Window:CloseBtn()
        local Dialog = Window:Dialog({
            Title = "Blyxing Hub",  
            Text = "Are you sure you want to leave the hub?", 
            Options = {
                {"Yes :<", function()  
                    ScreenGui:Destroy()
                end},
    ...
    function Window:Dialog(Configs)
        ...
        })Make("Stroke", Frame)Make("Corner", Frame, UDim.new(0, 12))Make("Gradient", Frame, {Rotation = 270})
        ...
        Make("Stroke", Screen)
        Make("Corner", Screen, UDim.new(0, 16))
        Frame.Parent = Screen
        CreateTween({Frame, "Size", UDim2.fromOffset(250, 150), 0.2})
        CreateTween({Frame, "Transparency", 0, 0.15})
        CreateTween({Screen, "Transparency", 0.45, 0.15})
    ...
    function Window:MakeTab(paste, Configs)
        ...
        function Tab:Visible(Bool)
            ...
            if Bool == nil then
                Container.Parent = Container.Parent and nil or Containers
            else
        ...
        function Tab:AddToggle(Configs)
            ...
            local ToggleHolder = InsertTheme(Create("Frame", Button, {
                ...
                BackgroundColor3 = Theme["Color Element"],
                BackgroundTransparency = 0.25
            }), "Frame")Make("Stroke", ToggleHolder, {Color = Theme["Color Element Stroke"]})Make("Corner", ToggleHolder, UDim.new(0.5, 0))
        ...
        function Tab:AddDropdown(Configs)
            ...
            local SelectedFrame = InsertTheme(Create("Frame", Button, {
                ...
                BackgroundColor3 = Theme["Color Element"],
                BackgroundTransparency = 0.25
            }), "Frame")Make("Stroke", SelectedFrame, {Color = Theme["Color Element Stroke"]})Make("Corner", SelectedFrame, UDim.new(0, 8))
            ...
            local DropFrame = Create("Frame", NoClickFrame, {
                ...
                ClipsDescendants = true,
                Active = true
            })Make("Stroke", DropFrame, {Color = Theme["Color Stroke"]})Make("Corner", DropFrame, UDim.new(0, 12))Make("Gradient", DropFrame, {Rotation = 60})
        ...
        function Tab:AddSlider(Configs)
            ...
            local SliderBar = InsertTheme(Create("Frame", SliderHolder, {
                ...
                AnchorPoint = Vector2.new(0.5, 0.5)
            }), "Frame")Make("Stroke", SliderBar, {Color = Theme["Color Element Stroke"]})Make("Corner", SliderBar, UDim.new(0, 4))
            ...
            }), "Theme")Make("Stroke", Indicator, {Color = Theme["Color Theme"]})Make("Corner", Indicator, UDim.new(0, 4))
            ...
            })Make("Stroke", SliderIcon, {Color = Theme["Color Theme"]})Make("Corner", SliderIcon, UDim.new(0, 4))
        ...
        function Tab:AddDiscordInvite(Configs)
            ...
            local FrameHolder = InsertTheme(Create("Frame", InviteHolder, {
                ...
                BackgroundColor3 = Color3.fromRGB(0, 0, 0),
                BackgroundTransparency = 0.25
            }), "Frame") Make("Stroke", FrameHolder, {Color = Theme["Color Stroke"]}) Make("Corner", FrameHolder, UDim.new(0, 12))
            ...
            local ImageLabel = Create("ImageLabel", FrameHolder, {
                ...
                Image = Logo,
                BackgroundTransparency = 1
            }) Make("Stroke", ImageLabel, {Color = Theme["Color Stroke"]}) Make("Corner", ImageLabel, UDim.new(0, 8))
            ...
            local JoinButton = Create("TextButton", FrameHolder, {
                ...
                BackgroundTransparency = 0.25,
                RichText = true
            }) Make("Stroke", JoinButton, {Color = Theme["Color Stroke"]}) Make("Corner", JoinButton, UDim.new(0, 8))
